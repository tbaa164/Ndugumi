...
export const Footer = () => {
  ...
  return (
    <footer className="bg-gradient-to-br from-ndugumi-green-dark to-green-900 text-white pt-16 pb-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><a href="#features" className="text-gray-300 hover:text-white transition-colors duration-300">Fonctionnalités</a></li>
              ...
              <li><a href="#testimonials" className="text-gray-300 hover:text-white transition-colors duration-300">Témoignages</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><a href="#" className="text-gray-300 hover:text-white transition-colors duration-300">Partenaires Agricoles</a></li>
              <li><a href="#" className="text-gray-300 hover:text-white transition-colors duration-300">Opportunités</a></li>
              <li><a href="#" className="text-gray-300 hover:text-white transition-colors duration-300">Devenez Partenaire</a></li>
            </ul>
          </div>
